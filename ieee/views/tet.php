...
<body>
	...
	<section class="tet__container">
		<div class='info__tet'>
			...
			<div class='logo_tet'>
				<img src="./ieee/assets/img/Logo_TET.png" alt="Error al cargar la imagen" class="img_logo_tet">
			</div>
			<div class='descp_tet'>
		...
		<div class="container">
			<div id="informacion" class="information">
				...
				<div class="information__graphic animate__animated animate__slideInRight">
					<img class="information__img" src="./ieee/assets/img/mision_tet.png" alt="" />
				</div>
			</div>
		</div>
	</section>
	...
	<section class="important2">
		<div class="container2">
			<div id="informacion2" class="information2">
				...
				<div class="information__graphic animate__animated animate__slideInRight">
					<img class="information__img" src="./ieee/assets/img/pintura.png" alt="" />
				</div>
