<div class="scripts">
    ...
    <!-- MENU BAR -->
    <script src="./ieee/assets/js/menu-bar.js"></script>
    <!-- CONTADORES -->
    <script src="https://cdn.jsdelivr.net/gh/tomik23/circular-progress-bar@1.1.9/dist/circularProgressBar.min.js"></script>
    <script src="./ieee/assets/js/circularProgressBar.min.js"></script>
    <script src="./ieee/assets/js/counters.js"></script>
    <!-- PARTICLES -->
    ...
    <script src="./ieee/assets/js/scroll-reveal.js"></script>
    <!-- GSAP - SCROLL-TRIGGER -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.9.1/gsap.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.9.1/ScrollTrigger.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.9.1/ScrollToPlugin.min.js"></script>
    <script src="./ieee/assets/js/gsap.js"></script>
</div>